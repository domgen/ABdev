ABdev - Quickest way to develop A/B tests 
===================
...
Next click on the "Load unpacked extension.." and choose the ABdev_extension folder from this repo.
> **Note:**
> Now you should see the extension installed in your browser. Go to the page that you wish to create an split test, a/b test or multivariate test and click on the extension's icon. Now toggle the "ON" button inside the extension's popup and you should be able to see your a/b test in action if you managed to create a new extension first using gulp --new my-new-extension. 
